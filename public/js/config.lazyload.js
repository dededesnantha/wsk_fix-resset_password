        ...
        $ocLazyLoadProvider.config({
            ...
            modules: [
                ...
                },
                {
                    ...
                    files: [
                        'vendor/modules/angular-bootstrap-colorpicker-master/css/colorpicker.min.css',
                        'vendor/modules/angular-bootstrap-colorpicker-master/js/bootstrap-colorpicker-module.min.js'
                    ]
                },
                {
                    name: 'ngjsColorPicker',
                    files: [                        
                        'vendor/modules/simeg-ngjs-color-picker/dist/ngjs-color-picker.js'
                    ]
                },
                {
                ...
                },
                {
                    name: 'ui.tinymce',
                    files: [                      
                        'vendor/tinymce/bower_components/tinymce/tinymce.min.js',                      

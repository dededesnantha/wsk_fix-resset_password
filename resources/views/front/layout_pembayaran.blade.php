...
<body itemscope itemtype="http://schema.org/WebPage">
  ...
  <div class="row">
    <div class="c-4 c-sm-4" style="padding: 10px 70px;">
      <a href="{{url()}}" title="">
        <div style="background-color: #067678;text-align: center; max-width: 226px;height: 116px;margin: 0 auto;">
          <div style=" padding-top: 26px">
            <i class="fa fa-home" aria-hidden="true" style="font-size: 30px; color: #fff"></i>
          </div>

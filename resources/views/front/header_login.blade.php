...
<head>
  ...
  <script>
  function select() {
    var d = document.getElementById("baju");
    var displaytext = d.options[d.selectedIndex].text;
    document.getElementById("ukurancelana").value=displaytext;
  }
</script>
@yield('script')
</head>
...
<body itemscope itemtype="http://schema.org/WebPage">
  ...
  <div class="row">
    <div class="c-4 c-sm-4" style="padding: 30px 70px">
      <div class="row">
        <div class="c-6">
          <a href="{{url()}}" title="">
        ...
        <a href="{{url('logout')}}" title="">
            <div style="background-color: #9ea9ac;text-align: center; max-width: 140px;margin: 0 auto;">
